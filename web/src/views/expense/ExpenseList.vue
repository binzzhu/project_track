    ...
    <el-card class="search-card">
      <el-form :inline="true" :model="searchForm" class="search-form">
        <el-form-item label="项目编码">
          <el-select v-model="searchForm.project_code" placeholder="请选择项目" clearable filterable style="width: 150px;">
            <el-option 
        ...
        <el-form-item label="单据编号">
          <el-input v-model="searchForm.document_no" placeholder="请输入单据编号" clearable style="width: 150px;" />
        </el-form-item>
        <el-form-item label="业务场景">
          <el-input v-model="searchForm.business_scene" placeholder="请输入业务场景" clearable style="width: 150px;" />
        </el-form-item>
